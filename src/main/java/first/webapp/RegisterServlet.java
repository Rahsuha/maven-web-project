	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		doGet(request, response);
	        ...
	        try {
	            ...
	            if (i > 0)
	                out.print("You are successfully registered user... <button onclick=\"window.location.href='http://localhost:8085/lesson14/register.jsp';\"> Click to go to user registration </button>" ); //print out this message as response
